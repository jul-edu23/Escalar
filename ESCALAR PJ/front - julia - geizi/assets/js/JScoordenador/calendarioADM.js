...
const sino = document.querySelector('g[clip-path="url(#clip0_205_352)"]');
        ...
        const notificacoes = [
            { texto: 'Solicitação de troca para 23/09', link: '#', lida: false },
            { texto: 'Atestado cadastrado', link: '#', lida: true },
            { texto: 'Pedido de férias para 01/09/2026 a 30/09/2026', link: '#', lida: true }
        ];
